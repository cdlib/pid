...
# ---------------------------------------------------------------
  def test_get_group_list
    ...
    assert_equal 'http://example.org/group/list', last_response.location, 'Did not get to the group list page!'
  end
...
puts last_response.inspect
    ...
    assert_equal "http://example.org/group/#{@group.id}", last_response.location, 'Did not get to the group page!'
  end
